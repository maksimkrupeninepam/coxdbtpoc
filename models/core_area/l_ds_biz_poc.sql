...
join {{source('collibra_source_tables','RELATION') }} rt on ds.ASSET_ID = rt.ASSET_ID1 and rt.ASSET_TYPE_NAME2 = 'Point of Contact' and rt.ROLE_OR_COROLE = 'Business Point of Contact'
